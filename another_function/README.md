...
To encode: python encode_image.py --model ||path to the trained encoder|| --images_dir=||path to images dir|| --save_dir=||path to location of wanted save dir||

To decode: python decode_image.py --model ||path to the trained decoder|| --images_dir=||path to the encoded images dir||